...
The basic principle is that when receiving a reward by tanking an action given a state, we increase the probability for taking this action when encounter a similar state \(\)
